...
<html lang="en">
  <head>
	...
	<body class="img js-fullheight" style="background-image: url('<?php echo base_url(RECURSOS_LOGIN_IMAGES.'bg.jpg')?>');">
  ...
  <script src="<?php echo base_url(RECURSOS_LOGIN_JS.'popper.js');?>"></script>
  <script src="<?php echo base_url(RECURSOS_LOGIN_JS.'bootstrap.min.js');?>"></script>
